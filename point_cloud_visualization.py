...
if __name__ == "__main__":
    ...
    pred_path = f"outputs/mv_recon/7scenes-{MODE}/fire-seq-04-pred.ply"
    gt_path = f"outputs/mv_recon/7scenes-{MODE}/fire-seq-04-gt.ply"
    ...
    plt.tight_layout()
    out_path = "fire-seq-04-comparison.png"
