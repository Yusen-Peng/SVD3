...
def main(hydra_cfg: DictConfig):
    ...
    # 0. create model
    COMPRESSED = True if 'whitening' in pretrained_model_name_or_path.lower() or 'lora' in pretrained_model_name_or_path.lower() or 'svd' in pretrained_model_name_or_path.lower() else False
