...
HERE = os.path.dirname(os.path.abspath(__file__))                     # .../Pi3_evaluation/monodepth
PI3_EVAL_ROOT = os.path.abspath(os.path.join(HERE, ".."))             # .../Pi3_evaluation
REPO_ROOT     = os.path.abspath(os.path.join(PI3_EVAL_ROOT, ".."))    # .../SVD-pi3

for p in (PI3_EVAL_ROOT, REPO_ROOT):
